...
def main(rank=None, model=None, opts=None, run=None, train_dataset=None, eval_dataset=None):
    ...
    if not os.path.exists("./model.pth") or opts["train"] or opts["gen_data"]:
        ...
        eval_ui_path = "/scratch/aledbetter/datasets/dgmg_datasets/user_inputs_new_ids"
        ...
        model = DGMG(
            ...
            user_input_path="/home/aledbetter/housing-design/housingpipeline/housingpipeline/dgmg/input.json",
        )
...
if __name__ == "__main__":
    os.chdir("/home/aledbetter/housing-design/housingpipeline/housingpipeline/dgmg")
    ...
    parser.add_argument(
        "--path-to-dataset",
        type=str,
        default="/scratch/aledbetter/datasets/dgmg_datasets/completed_graphs_final.pickle",
    )
    parser.add_argument(
        "--path-to-initialization-dataset",
        type=str,
        default="/scratch/aledbetter/datasets/dgmg_datasets/partial_graphs_final.pickle",
    )
    parser.add_argument(
        "--path-to-ui-dataset",
        type=str,
        default="/scratch/aledbetter/datasets/dgmg_datasets/user_inputs_final/",
    )
    parser.add_argument(
